namespace WindowsFormsApp1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "\"¡Bienvenido al formulario de Jhostyn y MT-2024-00676!\".";
            ...
            this.label2.Text = "1. Diseña un formulario simple con una etiqueta (Label) que diga \"¡Bienvenido al " +
    "formulario de NOMBRE y MATRICULA!\".";
