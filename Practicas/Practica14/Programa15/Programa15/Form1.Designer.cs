namespace Programa15
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "15. Usa controles OpenFileDialog y SaveFileDialog. Permite abrir un archivo de te" +
    "xto y mostrar su contenido en una caja de texto, y guardar cambios en el archivo" +
    ".";
